...
print("=== TESTING CLEAN FUNCTION CALLS (NO DEBUG) ===")
...
print("Executing both calls...")
ast_both = parse(test_code_both)
result_both = eval_ast(ast_both)
print(f"Final result: {result_both}")
