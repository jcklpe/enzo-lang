...
# Test the conditional pipelining followed by the next section
...
# Write test file
with open('/tmp/test_combined_sections.enzo', 'w') as f:
    f.write(test_file_content)

# Run the interpreter
proc = subprocess.run(
    ["poetry", "run", "enzo", "/tmp/test_combined_sections.enzo"],
    capture_output=True,
    text=True,
