#!/usr/bin/env python3
"""Simplified bubble sort test to debug."""
...
bubble-sort: (
    ...
    Loop while $pass is at most 1, (
        ...
        Loop while $position is less than $length, (
            ...
            "Comparing <$current-elem> and <$next-elem>";
            ...
            If $current-elem is greater than $next-elem, (
                ...
                "Current list after swap: <$current-list>";
            );
...
print("=== Testing simplified bubble sort ===")
ast = parse(test_code)
result = eval_ast(ast)
